...
public class LLcou {
  ...
  public  int[][] ringPath = new int[][]{
            ...
            {9,360,5,462,60,-90,85,85},
            {1,461,-70,619,100,170,-160,160},
            {7,618,5,720,60,-90,-85,90},
            {8,668,5,985,5,0,0,317},
            {9,895,5,1075,180,0,-90,90},
            {6,1074,93,1074,2145,0,0,2052},
            {3,895,2055,1075,2235,90,-90,90},
            {2,93,2235,986,2235,0,0,893},
            {1,5,2055,180,2235,180,-90,90},
            {4,5,93,5,2145,0,0,2052}
    };
